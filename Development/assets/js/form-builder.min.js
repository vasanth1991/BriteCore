...
! function(A) {
            ...
            Q = function A(e, t) {
                ...
                if (N.on("click touchstart", ".remove", function(A) {
                        ...
                        if (document.addEventListener("modalClosed", function() {
                            ...
                            var a = f.default.markup("h4", p.warning),
    ...
    81: function(A, e, t) {
        ...
        e.default = f, s.default.register(["paragraph", "header"], f), s.default.register(["p", "address", "blockquote", "canvas", "output"], f, "paragraph"), s.default.register([ "h4"], f, "header")
    },
    82: function(A, e, t) {
        "use strict";
